...
function heartclick() {
    ...
    if (y == 0) {
        btnheart.setAttribute("style", "background-image: url(./image/Vectorheart-black.svg)");
        y = 1;
    }
    else if (y = 1) {
...
function heartclick2() {
    ...
    if (y2 == 0) {
        btnheart2.setAttribute("style", "background-image: url(./image/Vectorheart-black.svg)");
        y2 = 1;
    }
    else if (y2 = 1) {
...
function heartclick3() {
    ...
    if (y3 == 0) {
        btnheart3.setAttribute("style", "background-image: url(./image/Vectorheart-black.svg)");
        y3 = 1;
    }
    else if (y3 = 1) {
...
function heartclick4() {
    ...
    if (y4 == 0) {
        btnheart4.setAttribute("style", "background-image: url(./image/Vectorheart-black.svg)");
        y4 = 1;
    }
    else if (y4 = 1) {
...
function heartclick5() {
    ...
    if (y5 == 0) {
        btnheart5.setAttribute("style", "background-image: url(./image/Vectorheart-black.svg)");
        y5 = 1;
    }
    else if (y5 = 1) {
...
function heartclick6() {
    ...
    if (y6 == 0) {
        btnheart6.setAttribute("style", "background-image: url(./image/Vectorheart-black.svg)");
        y6 = 1;
    }
    else if (y6 = 1) {
